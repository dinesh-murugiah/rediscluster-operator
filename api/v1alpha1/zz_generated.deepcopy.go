...
func (in *DistributedRedisClusterSpec) DeepCopyInto(out *DistributedRedisClusterSpec) {
	*out = *in
	...
	if in.AdditionalSecret != nil {
		in, out := &in.AdditionalSecret, &out.AdditionalSecret
		*out = make([]v1.LocalObjectReference, len(*in))
		copy(*out, *in)
	}
	if in.Monitor != nil {
...
func (in *DistributedRedisClusterStatus) DeepCopyInto(out *DistributedRedisClusterStatus) {
	*out = *in
	if in.SecretsVer != nil {
		in, out := &in.SecretsVer, &out.SecretsVer
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *HAspec) DeepCopyInto(out *HAspec) {
	*out = *in
	if in.ZonesInfo != nil {
		in, out := &in.ZonesInfo, &out.ZonesInfo
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *RedisClusterBackupSpec) DeepCopyInto(out *RedisClusterBackupSpec) {
	*out = *in
	if in.UtilSpec != nil {
		in, out := &in.UtilSpec, &out.UtilSpec
		*out = new(UtilSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UtilSpec) DeepCopyInto(out *UtilSpec) {
	*out = *in
	if in.TerminationGracePeriod != nil {
		in, out := &in.TerminationGracePeriod, &out.TerminationGracePeriod
		*out = new(int64)
...
func (in *UtilSpec) DeepCopy() *UtilSpec {
	if in == nil {
		return nil
	}
	out := new(UtilSpec)
